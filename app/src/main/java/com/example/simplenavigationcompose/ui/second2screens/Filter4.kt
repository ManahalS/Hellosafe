...
fun Filter4Screen(
    ...
    Column (
        ...
        Text("ISP-level filtration and server-side filtration (not recommended)", fontSize = 60.sp, textAlign = TextAlign.Center)
