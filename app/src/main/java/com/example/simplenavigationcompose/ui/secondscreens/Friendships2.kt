...
fun Friendships2Screen(
    ...
    Column (
        ...
        Text("how to prevent dangerous online friendships from forming", fontSize = 60.sp, textAlign = TextAlign.Center)
